                ...
                <div class="main-profile">
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            ?>
                            <img src="<?php echo esc_url($avatar); ?>" alt="Profile Picture" style="border-radius: 23px;">
                        </div>
                        ...
                        <div class="col-lg-4 align-self-center">
                            <div class="main-info header-text">
                                ...
                                <p>Current Rank: <strong>#5</strong></p> <!-- Dynamic Rank can be added if stored -->
                                <p>Total Score: <strong>3420</strong></p> <!-- Dynamic Score from DB -->
                                <p>Badges Earned:</p>
