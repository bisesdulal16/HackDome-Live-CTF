...
<div class="terminal-container">
    ...
    <div class="terminal-body">
        ...
        <?php if (!is_user_logged_in()) : ?>
            ...
            <p class="terminal-text">[+] Please complete your payment to activate your HackDome account.</p>
            ...
            <div class="payment-section">
                ...
                echo do_shortcode('[accept_stripe_payment 
                    ...
                    success_url="' . home_url('/register?payment=success') . '" 
        ...
        <?php else : ?>
            <p class="terminal-text success">
                <i class="fa fa-check-circle"></i> You are already logged in. <a href="<?php echo esc_url(home_url('/')); ?>">Go to Dashboard</a>
            </p>
        <?php endif; ?>
...
<?php if (isset($_GET['payment']) && $_GET['payment'] == 'success') : ?>
    <div class="payment-success">
        <p class="terminal-text success"><i class="fa fa-check-circle"></i> Payment completed successfully! Redirecting to registration...</p>
        <script>
            setTimeout(function () {
                window.location.href = "<?php echo home_url('/register?payment=success'); ?>"; // Redirect to registration after success
            }, 3000);
        </script>
    </div>
